...
def unet_model(n_classes=3, im_sz=320, n_channels=4, n_filters_start=32, growth_factor=2, upconv=True,
               class_weights=[0.33, 0.33, 0.33]):
    droprate=0.25
    logger.info("line no 18")
